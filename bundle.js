	...
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(_containers.AudioController, null),
	            _react2.default.createElement(_containers.TrackList, null),
	            _react2.default.createElement(_containers.AddTrack, null)
	        )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    var trackList = arguments.length <= 0 || arguments[0] === undefined ? init : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case 'ADD_SONG':
	            return trackList.push((0, _immutable.Map)(action.payload));
	        case 'TOGGLE_SONG':
	            return trackList.map(function (t) {
	                if (t.get('id') === action.payload) {
	                    if (t.get("isPlaying")) (0, _audioController.stopSong)();else (0, _audioController.loadSong)(t.get('url'));
	                    return t.update('isPlaying', function (isPlaying) {
	                        return !isPlaying;
	                    });
	                } else if (t.get('isPlaying')) {
	                    //Make sure there isn't another button showing Play
	                    return t.update('isPlaying', function (isPlaying) {
	                        return !isPlaying;
	                    });
	                } else {
	        ...
	        case 'CHANGE_VOLUME':
	            (0, _audioController.changeVolume)(action.payload);
	        default:
	            return trackList;
	    }
	};
	...
	var _audioController = __webpack_require__(197);

	//Just to get you a couple songs to start with
	var init = (0, _immutable.List)([(0, _immutable.Map)({ id: 0, url: "./res/dreammachine.mp3", artist: "Lazerhawk", track: "Dream Machine", isPlaying: false }), (0, _immutable.Map)({ id: 1, url: "./res/discozombi.mp3", artist: "Carpenter Brut", track: "Disco Zombi Itaila", isPlaying: false }), (0, _immutable.Map)({ id: 2, url: "./res/highwaytohell.m4a", artist: "AC/DC", track: "Highway to Hell", isPlaying: false })]);
...
/***/ function(module, exports) {
	...
	var context = window.AudioContext || window.webkitAudioContext; //Cross browser compatibliltiy
	var AC = new context();
	...
	var error_handler = function error_handler(e) {
	    return alert("Error parsing audio \nError:" + e.err);
	};
	...
	function loadSong(url) {
	    ...
	    request.onload = function () {
	        AC.decodeAudioData(request.response).then(function (b) {
	            playSong(b);
	        }, error_handler);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AddTrack = exports.AudioController = exports.TrackList = undefined;
	...
	var _addtrackComponent = __webpack_require__(201);

	var _addtrackComponent2 = _interopRequireDefault(_addtrackComponent);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

	//imports all the functions as a list called components
	var TrackList = exports.TrackList = (0, _reactRedux.connect)(function mapStateToProps(state) {
	    return { tracks: state };
	}, function mapDispatchToProps(dispatch) {
	    return { toggleSong: function toggleSong(id) {
	            return dispatch((0, _actions.toggleSong)(id));
	        } };
	})(components.TrackList);

	var AudioController = exports.AudioController = (0, _reactRedux.connect)(function mapStateToProps(state) {
	    return { tracks: state };
	}, function mapDispatchToProps(dispatch) {
	    return { changeVolume: function changeVolume(v) {
	            return dispatch((0, _actions.changeVolume)(v));
	        } };
	})(components.AudioController);

	var AddTrack = exports.AddTrack = (0, _reactRedux.connect)(function mapStateToProps(state) {
	    return {};
	}, function mapDispatchToProps(dispatch) {
	    return {
	        addTrack: function addTrack(url, artist, name) {
	            return dispatch((0, _actions.addTrack)(url, artist, name));
	        }
	    };
	})(_addtrackComponent2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Track(props) {
	    ...
	    return _react2.default.createElement(
	        'tr',
	        { className: track.isPlaying ? "track track--playing" : "track" },
	        _react2.default.createElement(
	            'td',
	            null,
	            _react2.default.createElement(
	                'button',
	                { onClick: toggleClick(track.id), className: 'track__button' },
	                track.isPlaying ? "P" : "S"
	            )
	        ),
	        _react2.default.createElement(
	...
	function TrackList(props) {
	    //Render the tracklist as a table
	    var tracks = props.tracks;
	    var toggleSong = props.toggleSong;


	    var toggleClick = function toggleClick(id) {
	        return function (event) {
	            return toggleSong(id);
	        };
	    };

	    return _react2.default.createElement(
	        'div',
	        { className: 'react-radio' },
	        _react2.default.createElement(
	            'table',
	            { className: 'playlist' },
	            _react2.default.createElement(
	                ...
	                tracks.map(function (t) {
	                    return _react2.default.createElement(Track, { key: t.get('id'), track: t.toJS(), toggleClick: toggleClick })
	...
	function AudioController(props) {
	    ...
	    var volumeChange = function volumeChange(event) {
	        ...
	        (0, _audioController.changeVolume)(element.value);
	    };
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'range', min: '0', max: '1', step: '0.01', defaultValue: '.5', onChange: volumeChange })
	        )
	    );
	}
...
/***/ function(module, exports) {
	...
	exports.toggleSong = toggleSong;
	exports.changeVolume = changeVolume;
	var uid = function uid() {
	    return Math.random().toString(34).slice(2);
	};

	function addTrack(url, artist, track) {
	    return {
	        type: 'ADD_SONG',
	        payload: {
	            id: uid(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddTrackComp = function (_Component) {
	    _inherits(AddTrackComp, _Component);

	    function AddTrackComp() {
	        _classCallCheck(this, AddTrackComp);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AddTrackComp).apply(this, arguments));
	    }

	    _createClass(AddTrackComp, [{
	        key: "render",
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement("br", null),
	                        _react2.default.createElement("input", { className: "form__text", id: "url", ref: "url", type: "text", onKeyDown: function onKeyDown(e) {
	                                return _this2.onSubmit(e);
	                            }, placeholder: "http://someurl.com/sound.mp3" })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { className: "form__row" },
	                        ...
	                        " ",
	                        _react2.default.createElement("br", null),
	                        _react2.default.createElement("input", { className: "form__text", ref: "artist", type: "text", onKeyDown: function onKeyDown(e) {
	                                return _this2.onSubmit(e);
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement("br", null),
	                        _react2.default.createElement("input", { className: "form__text", type: "text", ref: "track", onKeyDown: function onKeyDown(e) {
	                                return _this2.onSubmit(e);
	                            }, placeholder: "Track title" })
	                    ),
	                    _react2.default.createElement(
	                        "button",
	                        { type: "button", className: "form__button", onClick: function onClick(e) {
	                                return _this2.onSubmit(e);
	                            } },
	                        "+"
	                    ),
	        ...
	        value: function onSubmit(e) {
	            ...
	            var nodes = { //keeps a reference of the text fields to grab the value and edit later
	                url: this.refs.url,
	            ...
	            var submitted = e.which == 13 ? true : false; //if the button was not clicked check to see if the enter key was pressed

	            if (submitted == true || e.type == "react-click") {

	                var errors = {};

	                if (nodes.url.value.length <= 0) errors.url = "Enter a URL \n";

	                if (nodes.artist.value.length <= 0) errors.artist = "Enter an artist name \n";

	                if (nodes.track.value.length <= 0) errors.track = "Enter a track name";

	                if (errors.url == null && errors.artist == null && errors.track == null) {
